        ...
        if manual == False:
            ...
            try:
                if settings['auto_ffilter']:
                    ai_search = True
                    reply_msg = await message.reply_text(f"<b><i>Searching For Your Query 🔍</i></b>")
...
async def pm_text(bot, message):
    ...
    if PM_SEARCH == True:
        ai_search = True
        reply_msg = await bot.send_message(message.from_user.id, f"<b><i>Searching For Your Query 🔍</i></b>", reply_to_message_id=message.id)
    ...
    if gl == False:
        ...
        if k == False:
            ...
            if files:
                ...
                ai_search = True
                reply_msg = await query.message.edit_text(f"<b><i>Searching For Your Query 🔍</i></b>")
     ...
     #   if not search:
      ...
      #      return
        ...
        buttons = [[
            ...
            InlineKeyboardButton('Uᴘᴅᴀᴛᴇ Cʜᴀɴɴᴇʟ', url="https://t.me/CinemaColonyUpdates")
        ],[
